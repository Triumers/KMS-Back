...
@Transactional
@SpringBootTest
public class CmdPostServiceTest {
    ...
    @Autowired
    public CmdPostServiceTest(CmdPostService cmdPostService, OpenAIService openAIService, LoggedInUser loggedInUser, AuthService authService, CmdTabService cmdTabService) {
